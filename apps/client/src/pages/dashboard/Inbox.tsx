...
function Inbox() {
  ...
  const fetchAllData = async () => {
    ...
    const sentData = await receiveMail.send(data);
...
console.log(data); 
        ...
        >
          <div className="mx-auto max-w-md rounded-lg bg-white shadow-md overflow-hidden mt-10">
            ...
            <div className="p-5">
              ...
              <div style={{ display: 'flex' }}>
                <h3 >Message: </h3>
                <span className="speaker-icon" onClick={() => {
                  speak(selectedEmailData?.mailData)
  ...
  <path d="M10.025 8a4.5 4.5 0 0 1-1.318 3.182L8 10.475A3.5 3.5 0 0 0 9.025 8c0-.966-.392-1.841-1.025-2.475l.707-.707A4.5 4.5 0 0 1 10.025 8M7 4a.5.5 0 0 0-.812-.39L3.825 5.5H1.5A.5.5 0 0 0 1 6v4a.5.5 0 0 0 .5.5h2.325l2.363 1.89A.5.5 0 0 0 7 12zM4.312 6.39 6 5.04v5.92L4.312 9.61A.5.5 0 0 0 4 9.5H2v-3h2a.5.5 0 0 0 .312-.11"/>
              ...
              <p>{selectedEmailData && selectedEmailData.mailData}</p>
            </div>
          </div>
        </div>
      )}
